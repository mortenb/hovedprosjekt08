...
Vi løste midlertidig problemet med minneforbruket ved å kalle en \verb doc->dispose() \end{verb} metode for hver fil vi hadde lest inn, fordi Perls Garbage Collector ikke selv gjorde dette. Men fortsatt var vi ikke fornøyd med hastigheten.
