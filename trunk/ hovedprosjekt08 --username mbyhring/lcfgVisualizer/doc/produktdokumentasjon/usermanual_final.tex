\documentclass[12pt,a4paper,english,twocolumns]{report}
\usepackage{verbatim}
\usepackage{alltt}
\usepackage{graphicx}
...
\section{HTML}
The HyperText Markup Language (HTML) is used when publishing documents on the world wide web. It consists of a set of codes that are interpreted by a web browser in order to present text, images and other media to a user.
