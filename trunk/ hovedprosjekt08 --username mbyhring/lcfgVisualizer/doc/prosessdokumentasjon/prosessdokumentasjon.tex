...
\\\\\noindent 
Vi hadde relativt liten kunnskap om Perl i de områdene vi har tenkt til å bruke det til i prosjektet. Det vi tidligere har gjort i Perl har vært mer maskinnært, mens vi nå jobber mot XML, database og generering av filer. Siden vi alle på gruppen har jobbet litt med Perl, har det ikke vært noen stor jobb å tilegne seg mer kunnskap i Perl. 
\\\\\noindent  
VRML har en relativt enkel syntaks, som ligner noe på ett oppmerkingsspråk. Dette vil si at man for det meste deklarer noder, og gir den forskjellige attributter med verdier som forteller hvor de respektive nodene skal være på skjermen. VRML gikk dermed fort å lære. VRML har støtte for JavaScript inne i seg, og dette er noe vi har brukt. For å få noder til å flytte seg slik vi vil, og for å dynamisk sette noders attributter har det vært en nødvendighet å bruke JavaScript. Vi har alle tidligere jobbet litt i JavaScript, men her kom det mange skjulte overraskelser. VRML har en del variabelnavn som vi måtte lære hva gjorde og hvordan bruke dem, og disse har en annerledes syntaks enn noe vi har vært borte i før. Umulig var det dog ikke, og ved hjelp av VRMLPad har vi kunnet eksperimentere og forske på hva de forskjellige variabelen er i stand til å gjøre.
\\\\\noindent  
