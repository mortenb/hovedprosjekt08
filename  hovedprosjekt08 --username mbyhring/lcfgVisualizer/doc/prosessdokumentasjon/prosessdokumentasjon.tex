...
En 'verden' i VRML har en struktur der alle objekter er plassert i et globalt koordinatsystem. I tillegg kan det defineres transformasjonsobjekter, som danner lokale koordinatsystemer for de objektene som tilhører dette. Plasseringen et objekt har globalt kan dermed avhenge av plasseringen i flere lokale koordinatsystemer.
\\
\\
