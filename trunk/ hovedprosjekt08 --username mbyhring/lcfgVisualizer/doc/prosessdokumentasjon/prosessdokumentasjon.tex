...
Denne delen forklarer om hvilke utviklingsfaser prosjektet har hatt, utfordringer i prosessen, og hvorfor valgene er gjort.b  
...
Farger...\\
database.. \\
-- Mye utdatert stoff på internett, vi brukte lang tid på å finne de virkelig gode nettsidene, Mye stoff omhandlet gamle spesifikasjoner eller gjaldt for utdaterte programmer, som gjorde det vanskelig å finne ut hva som `'gjelder nå`'.
Litt bratt lærekurve for å beherske VRML.
De ulike VRML Browserne fulgte ikke nødvendigvis de samme spesifikasjonene, slik at gyldig VRML-kode kunne oppføre seg forskjellig i to programmer.
..Kanskje vi kan si at dette var grunnen til at vi valgte å standardisere på kun en vrml-klient browser, at octaga virket mest robust og ferdig..
