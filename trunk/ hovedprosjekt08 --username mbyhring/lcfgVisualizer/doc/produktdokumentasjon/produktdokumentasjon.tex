...
\subsection{GroupVisulizer}
\subsection{PyramidVisulizer}
The pyramed visualizer module depends on the following modules: 
\begin{itemize}
\item[-]
DAL.pm
\item[-]
...
\subsection{NodeVisulizer}
\subsection{heatMapVisulizer}
...
\begin{verbatim}LoadModule alias_module modules/mod_alias.so
LoadModule cgi_module modules/mod_cgi.so"
\end{verbatim}
in the section \verb"<IfModule alias_module>"
\begin{verbatim}
