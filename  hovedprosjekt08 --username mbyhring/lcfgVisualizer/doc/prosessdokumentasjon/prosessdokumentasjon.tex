...
Dette har hjulpet oss i programmeringen, samt til å forstå mange av konfigurasjonsparametrene som forekommer i profilene.
...
Vi har heller ikke brukt Latex som dokumentasjonsverktøy før, og ser på denne prosjektperioden som en fin anledning til å lære oss dette.
...
\item \textbf{Information pyramids} (fig. \ref{pyramid} )
...
\subsubsection{Hva skal vi visualisere?}
...
Vi har valgt å implementere løsningen som en Web-applikasjon, da kombinasjonen *AMP (Apache, MySQL, Perl) er en god og plattformuavhengig kombinasjon, samt at det ikke stiller store krav til klienten, som egentlig kun trenger å kunne vise HTML, javascript og VRML.
