...
This part of the program connects to the database and generates a visualisation based on the criteria and techniques chosen by the user.
...
On Windows, we recommend using ActivePerl \footnote{http://www.activestate.com} and 
...
You need to configure your Apache Server to serve the CGI scripts located in the \textbf{installation path/cgi} folder. In short terms, you need the following lines in the \verb"loadModule" section of \verb"httpd.conf":
\begin{verbatim}
